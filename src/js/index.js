...
personagens.forEach((personagem) => {
    ...
    //Funcao que vai remover a selecao do personagem// deixar mais obvio
...
function alterarDescricaoPersonagem(personagem) {
    const descriçãoPersonagem = document.getElementById('descricao-personagem'); descriçãoPersonagem.innerText = personagem.getAttribute('data-description');
}
